...
#define ADD0 "192.168.43.49"//"10.250.8.207"  //"192.168.0.133" //dell-4
#define ADD1 "192.168.43.189"//"10.250.74.145" //dell-4
...
//            return;
    ...
    Listener()
    {
        ...
        address[0]="192.168.43.49";
        address[1]="192.168.43.189";
...
//            cout<<listener.port<<endl;
            listener.address[0]="192.168.43.49";
            listener.address[1]="192.168.43.189";
            listener.port = "1234";
